...
git subtree add --squash -P "vendor/$1" "https://$1" master

# Prefix import paths with "github.com/iron-io/vendor/". This is a pretty dumb
...
find -name '*.go' -exec sed -i s,\""$1\(/.*\)\?"\",\""github.com/iron-io/ironcli/vendor/$1\1"\", {} +
